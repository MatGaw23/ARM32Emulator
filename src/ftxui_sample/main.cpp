...
// configuration step. It creates a namespace called `ARM32Emulator`. You can modify
...
{
  try {
    CLI::App app{ fmt::format("{} version {}", ARM32Emulator::cmake::project_name, ARM32Emulator::cmake::project_version) };
    ...
    if (show_version) {
      fmt::print("{}\n", ARM32Emulator::cmake::project_version);
      return EXIT_SUCCESS;
    }
